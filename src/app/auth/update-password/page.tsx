   ...
   if (error && !message) { // Show initial error prominently
    return (
        <div className="flex flex-col items-center justify-center min-h-screen py-2">
            ...
            <Link href="/auth/forgot-password" className="text-brand-primary hover:text-brand-primary/80">
      ...
      <form onSubmit={handleUpdatePassword} className="w-full max-w-sm">
        <div className="mb-4">
          ...
          <input
            ...
            required
            minLength={6}
            className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-brand-primary focus:border-brand-primary sm:text-sm text-black"
            placeholder="••••••••"
          />
        </div>
        <div className="mb-4">
        ...
        <button
          ...
          className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-brand-white bg-brand-primary hover:bg-brand-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-primary disabled:opacity-50"
        >
